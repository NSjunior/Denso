...
<div style="line-height:30px;padding-top: 50px; display:flex; justify-content:center; align-items:center;">
    <div style="text-align:center;font-size:14pt;">
        <strong style="font-size:18pt;">แผนที่บ้านของนักเรียน</strong> (แผนที่การเดินทางจากบ้านถึงโรงเรียน)
    </div>
    <div style="text-align:center;border: 2px solid;width: 75%;max-height: 75%;">
        <?php echo $image1 ?>
    </div>
    <br />
